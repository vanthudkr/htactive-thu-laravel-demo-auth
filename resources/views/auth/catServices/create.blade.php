            ...
            <div class="col-md-8 offset-md-2">
                ...
                <div class="card">
                    <div class="card-header card-header-primary">
                        <p class="card-title font-weight-bold text-center "> You are standing at create catService page </p>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('catService.store') }}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
